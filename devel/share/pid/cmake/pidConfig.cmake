...
if("TRUE" STREQUAL "TRUE")
  set(pid_SOURCE_PREFIX /home/brad/Documents/GitHub/red_rover_popenc_fork/src/pid)
  set(pid_DEVEL_PREFIX /home/brad/Documents/GitHub/red_rover_popenc_fork/devel)
  set(pid_INSTALL_PREFIX "")
  set(pid_PREFIX ${pid_DEVEL_PREFIX})
else()
  set(pid_SOURCE_PREFIX "")
  set(pid_DEVEL_PREFIX "")
  set(pid_INSTALL_PREFIX /home/brad/Documents/GitHub/red_rover_popenc_fork/install)
...
if(NOT "/home/brad/Documents/GitHub/red_rover_popenc_fork/devel/include;/home/brad/Documents/GitHub/red_rover_popenc_fork/src/pid/include " STREQUAL " ")
  set(pid_INCLUDE_DIRS "")
  set(_include_dirs "/home/brad/Documents/GitHub/red_rover_popenc_fork/devel/include;/home/brad/Documents/GitHub/red_rover_popenc_fork/src/pid/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pid' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/brad/Documents/GitHub/red_rover_popenc_fork/src/pid/${idir}'.  Ask the maintainer 'Andy Zelenak <andyz@utexas.edu>' to fix it.")
    endif()
